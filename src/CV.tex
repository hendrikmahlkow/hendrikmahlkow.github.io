...
\begin{minipage}[t]{0.8\textwidth} 
    ...
    \begin{itemize}
        \item[-] Various public sector stakeholders (e.g., UNIDO, GIZ, German State Ministries)
        \item[-] Providing analytical support and strategic advice at the intersection of economic research, data science, and programming
    \end{itemize}
\end{minipage}
\medskip
