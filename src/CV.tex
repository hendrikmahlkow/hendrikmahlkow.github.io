...
\hspace{5mm}
\begin{minipage}[t]{0.8\textwidth} 
    Postdoctoral Researcher, Kiel University, since 2026 \par
    Researcher, Kiel Institute for the World Economy, since 2024 \par
    Research Associate, Austrian Institute of Economic Research (WIFO), since 2026 \par
    Independent Consultant, Programmer, \& Data Scientist, since 2020 \par
    \begin{itemize}
...
\hspace{5mm}
\begin{minipage}[t]{0.8\textwidth} 
    Economist, Austrian Institute of Economic Research,  2023--2025 \par
...
\begin{minipage}[t]{0.12\textwidth}
    {\fontfamily{phv}\selectfont RESEARCH VISITS} \\
\end{minipage}
\hspace{5mm}
\begin{minipage}[t]{0.8\textwidth}
    University of California, Berkeley, March 2026 \par
    University of California, Berkeley, 2022--2023 \par
    \begin{itemize}
...
\hspace{5mm}
\begin{minipage}[t]{0.8\textwidth}
    \href{https://www.kielinstitut.de/de/publikationen/quantitative-trade-with-ships-19579/}{``Quantitative Trade with Ships''} with Sonali Chowdhry and Inga Heiland, 2026. \par
    \href{https://www.kielinstitut.de/de/publikationen/tariffs-hit-differently-the-regional-impact-of-us-tariffs-across-europe-and-the-role-of-the-single-market-19225/}{``Tariffs Hit Differently: The Regional Impact of US tariffs across Europe and the Role of the Single Market''} with Julian Hinz and Joschka Wanner, 2025. \par
    \href{https://trade.ifw-kiel.de/KTTM/KITE_whitepaper.pdf}{``The KITE Model Suite: A Quantitative Framework for
International Trade Analysis''} with Gabriel Felbermayr, Julian Hinz, Sebastian Krantz, and Joschka Wanner, 2025. \par
...
\hspace{5mm}
\begin{minipage}[t]{0.8\textwidth}
    ``Who Pays the Tariffs?'' with Julian Hinz, Aaron Lohmann, and Anna Vorwig.\par
...
\hspace{5mm}
\begin{minipage}[t]{0.8\textwidth}
  \href{https://doi.org/10.18723/diw_wb:2026-28-1}{``Chinas Dominanz im Schiffbau und US-Handelspolitik schaffen neue Risiken für Europa und andere Handelspartner''} with Sonali Chowdhry and Inga Heiland, \textit{DIW Wochenbericht}, 93(28), July 2026. \par
  \href{https://doi.org/10.2478/wd-2026-00}{``Grenzausgleich für die EU-Klimapolitik: Optionen und ihre ökonomischen Wirkungen''} with Gabriel Felbermayr, Friedrich Lührs, Johannes Müller, Isabel Pham, Robin Sogalla, and Joschka Wanner, \textit{Wirtschaftsdienst}, 106(5), May 2026. \par
  \href{https://doi.org/10.2478/wpbl-2026-0003}{``Der EU-Binnenmarkt als Schutzschild: Wie Europa den Handelskrieg mit den USA abfedert''} with Gabriel Felbermayr, Julian Hinz, Sebastian Krantz, and Joschka Wanner, \textit{Wirtschaftspolitische Blätter}, 2026(1), May 2026. \par
  \href{https://www.kielinstitut.de/publications/americas-own-goal-who-pays-the-tariffs-19398/}{``America’s Own Goal: Who Pays the Tariffs?''} with Julian Hinz, Aaron Lohmann, and Anna Vorwig, \textit{Kiel Policy Brief}, January 2026. \par
  \href{https://www.kielinstitut.de/publications/the-eu-india-trade-deal-strategic-diversification-in-an-era-of-uncertainty-19443/}{``The EU–India Trade Deal: Strategic Diversification in an Era of Uncertainty''} with Julian Hinz, Rolf Langhammer,
and, Vasundhara Thakur, \textit{Kiel Policy Brief}, January 2026. \par
  \href{https://www.familienunternehmen.de/de/publikationen/wie-kann-cbam-funktionieren}{``Wie kann CBAM funktionieren?''} with Gabriel Felbermayr, Isabel Pham, Robin Sogalla, and Joschka Wanner, Kurzstudie im Auftrag der Stiftung Familienunternehmen, Dezember 2025. \par
  ...
  \href{https://www.familienunternehmen.de/de/publikationen/transatlantische-kooperation-statt-zollkrieg}{``Transatlantische Kooperation statt Zollkrieg''} with Gabriel Felbermayr, Alexander Sandkamp, and Elisabeth Christen, Studie im Auftrag der Stiftung Familienunternehmen, Mai 2025. \par
  ``The Global Domino: Impacts of Rising Tariff Barriers on Developing Countries' Industries'' with Gabriel Felbermayr, Study prepared for the United Nations Industrial Development Organization (UNIDO), 2025. \par
...
\begin{minipage}[t]{0.8\textwidth}
    \textit{2026} \\
    3rd Kiel-Göttingen-CEPR Conference ``China in the Global Economy''; FIND Seminar, Aarhus University. \par
    \textit{2025} \\
    Globalization, Shipping and Trade Workshop, Paris School of Economics; ETSG in Milan; Journal of International Economics Summer School, Munich; Aarhus-Kiel Trade Workshop. \par
    \textit{2024} \\
...
\hspace{5mm}
\begin{minipage}[t]{0.8\textwidth}
  \href{https://www.bpb.de/kurz-knapp/hintergrund-aktuell/578241/viele-menschen-in-entwicklungslaendern-koennen-die-steigenden-lebensmittelpreise-nicht-ausgleichen/}{``Viele Menschen in Entwicklungsländern können die steigenden Lebensmittelpreise nicht ausgleichen''}, Bundeszentrale für politische Bildung (bpb.de), [\textit{interview}], May 26, 2026 \par
  \href{https://www.ardmediathek.de/video/Y3JpZDovL3dkci5kZS9CZWl0cmFnLXNvcGhvcmEtMzNjMDQwZjYtY2IxMi00OWM0LWI2YWQtYTQ2ZWE2Nzc3OWVh}{Europamagazin über Ölkrise und Inflationserwartung}, ARD, March 8, 2026 \par
  \href{https://www.zdf.de/play/magazine/heute-19-uhr-102/heute-19-uhr-vom-02-maerz-2026-100}{heute Nachrichten über Ölkrise und Inflationserwartung}, ZDF, March 2, 2026 \par
  \href{https://www.sueddeutsche.de/wirtschaft/zoll-drohungen-auswirkungen-wirtschaft-li.3371354?reduced=true}{``Was Trumps Zoll-Drohungen für die deutsche Wirtschaft bedeuten''}, Süddeutsche Zeitung, January 19, 2026 \par
...
\begin{minipage}[t]{0.12\textwidth}
    {\fontfamily{phv}\selectfont TEACHING} \\
\end{minipage}
\hspace{5mm}
\begin{minipage}[t]{0.8\textwidth}
    \textit{Kiel University} \\
    Reale Außenwirtschaft (lecture, B.Sc.), 2026 \par
    Empirische Analyse von Handelspolitik (seminar, M.Sc.), 2026 \par
    \textit{Professional Training} \\
    Strengthening Uzbekistan's Capacity in Foreign Trade Forecasting, four-day seminar for the Uzbek Ministry of Investment, Industry and Trade, commissioned by GIZ, Tashkent, July 2026 \par
\end{minipage}
\medskip
...
\hspace{5mm}
\begin{minipage}[t]{0.8\textwidth}
    Economic Modeling, International Economics, Review of World Economics (3x), Agricultural Economics, Empirica.
\end{minipage}
\medskip
...
\begin{minipage}[t]{0.8\textwidth}
  \textit{2026} \\
    Talk on the economic effects of US tariffs, Kieler Woche, Kiel; Expert roundtable on global supply-chain shocks, maritime networks, and port resilience, Consulate General of the Republic of Korea, Hamburg. \par
  \textit{2025} \\
    Talk on transatlantic cooperation instead of tariff conflicts, Forum Bundesbank;
...
\hspace{5mm}
\begin{minipage}[t]{0.8\textwidth}
    \textit{Proficient}: R, Git, LaTeX, Google Earth Engine \par
    \textit{Competent}: Python, GAMS, C++, JavaScript
\end{minipage}
\medskip
